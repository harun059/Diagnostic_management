...
import com.harun.diagnosticmanagementsystem.dao.AppointmentsService;
...
import com.harun.diagnosticmanagementsystem.dao.PrescriptionService;
import com.harun.diagnosticmanagementsystem.dao.PrescriptiondrugService;
import com.harun.diagnosticmanagementsystem.dao.TestService;
import com.harun.diagnosticmanagementsystem.dao.TestprescriptionService;
import com.harun.diagnosticmanagementsystem.dao.TestreportService;
import com.harun.diagnosticmanagementsystem.dao.TesttypeService;
import com.harun.diagnosticmanagementsystem.dao.ViewPrescriptiondrugService;
import com.harun.diagnosticmanagementsystem.model.Cart;
import com.harun.diagnosticmanagementsystem.model.Doctor;
import com.harun.diagnosticmanagementsystem.model.Patient;
import com.harun.diagnosticmanagementsystem.model.Prescription;
import com.harun.diagnosticmanagementsystem.model.Prescriptiondrug;
...
public class PrescriptionController {
    ...
    public ModelAndView showprescriptionlistpage(HttpSession session) {
        ...
        if (cd.isEmpty()) {
            ...
            session.setAttribute("grandtotal", getGrandTotal(cd));
...
//            purchaseDetailService.updatePurchasedetail(cart.getPid(), p);
        ...
        for (TestPrescriptionCart cart : cd) {
            ...
            tpa.setGrandtotal((double) httpSession.getAttribute("grandtotal"));
            testdetail.add(tpa);
...
//            purchaseDetailService.updatePurchasedetail(cart.getPid(), p);
    ...
    public double getGrandTotal(ArrayList<TestPrescriptionCart> item) {
        double gtotal = 0;
        ListIterator<TestPrescriptionCart> itr = item.listIterator();
        while (itr.hasNext()) {
            TestPrescriptionCart ob = (TestPrescriptionCart) itr.next();
            gtotal = gtotal + ob.getAmount();
        }
        return gtotal;
    }
