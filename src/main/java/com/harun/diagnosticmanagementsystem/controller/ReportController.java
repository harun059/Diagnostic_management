...
import com.harun.diagnosticmanagementsystem.dao.PaymentinfoService;
...
import com.harun.diagnosticmanagementsystem.daoimpl.JasperReportDao;
import com.harun.diagnosticmanagementsystem.model.Appointments;
import com.harun.diagnosticmanagementsystem.model.Paymentinfo;
...
import com.harun.diagnosticmanagementsystem.reportmodel.AppointmentBill;
import com.harun.diagnosticmanagementsystem.reportmodel.AppointmentReport;
import com.harun.diagnosticmanagementsystem.reportmodel.BillReport;
import com.harun.diagnosticmanagementsystem.reportmodel.PaymentReport;
import com.harun.diagnosticmanagementsystem.reportmodel.PrescriptionReport;
...
public class ReportController {
    ...
    public String generatePresReport(@ModelAttribute("reportInputForm") PaymentReport reportInputForm,HttpServletRequest request,HttpServletResponse response,@RequestParam("getpid") int pid) throws JRException, IOException, SQLException, NamingException {
        String reportFileName = "finalprescription";
        JasperReportDao jrdao = new JasperReportDao();
        Connection conn = null;
        try {
            conn = jrdao.getConnection();
